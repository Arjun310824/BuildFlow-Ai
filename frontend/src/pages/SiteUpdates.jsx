    ...
    <div className="page-container">
      ...
      <div className="page-header-row">
        <div className="page-header-titles">
          <h1>{t('siteUpdates.title', 'Site Updates')}</h1>
          <p>{t('siteUpdates.subtitle', 'Chronological daily construction logs, superintendent shift reports, and site photographic records.')}</p>
        </div>
          ...
          >
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                ...
                <span className="badge badge-info">{t('siteUpdates.shiftCompleted', 'Shift Completed')}</span>
              </div>
              ...
              <div style={{ display: 'flex', gap: '24px', alignItems: 'center', flexWrap: 'wrap', marginBottom: '14px' }}>
                <div style={{ width: '180px' }}>
                  <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', marginBottom: '2px' }}>
                    {t('siteUpdates.milestoneProgress', 'Milestone Progress')}
                  </div>
              ...
              >
                ...
                >
                  ...
                  <span style={{ fontSize: '0.7rem', fontWeight: 600, color: 'var(--text-muted)' }}>
                    {t('siteUpdates.sitePhoto', 'Site Photo')}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  {t('siteUpdates.clickToView', 'Click to View')}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="modal-body" style={{ textAlign: 'center' }}>
              ...
              >
                ...
                <div style={{ fontWeight: 600, fontSize: '1.1rem' }}>
                  {t('siteUpdates.previewTitle', 'High-Resolution Site Survey Capture')}
                </div>
                <div style={{ fontSize: '0.8rem', color: '#94a3b8' }}>
                  {t('siteUpdates.previewSubtitle', 'Verified by Field QC Drone & On-Site Supervisor')}
                </div>
              </div>
